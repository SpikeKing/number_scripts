...
class ServicesVersus(object):
    ...
    """
    def __init__(self):
        self.file_name = os.path.join(DATA_DIR, 'numbers_files', 'numbers_dataset_v1_test.txt')
        self.out_file = os.path.join(DATA_DIR, 'numbers_dataset_v1_test.vs-{}.txt'.format(get_current_time_str()))
